...
define('_MI_XPETITIONS_MENU2',			'Creation');
define('_MI_XPETITIONS_MENU3',			'Modification');
define('_MI_XPETITIONS_MENU4',			'Manage signatures');
define('_MI_XPETITIONS_MENU5',			'Manage emails');
define('_MI_XPETITIONS_MENU6',			'Manage fields');
